...
import com.synear.mapper.OrderItemsMapper;
import com.synear.mapper.OrderStatusMapper;
import com.synear.mapper.OrdersMapper;
...
//            itemService.decreaseItemSpecStock(itemSpecId, buyCounts);
    ...
    public ShopcartBO getBuyCountFromShopCart(List<ShopcartBO> shopcartList, String specId){
        for (ShopcartBO s : shopcartList) {
            if (s.getSpecId().equals(specId)) {
                return s;
            }
        }
        return null;
